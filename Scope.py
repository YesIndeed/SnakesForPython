...
# Look for questions marked "Q" -- these will be asked in discussion

# Part 1: Global Variables
# Q: What happens if we get rid of the global keyword? Will that happen no matter where we use global?
global scores
...
# Q: We're outside of our loop. What happens if we print i?

# Part 3: Variables in functions
def check_high_score(oldScore, newScore):
    #Q: We're inside our function. What value does newScore have?
    if oldScore < newScore:
        return newScore
    else:
        return oldScore
# Q: We're outside of our function. What value does newScore have?

# Part 4: Variables in Classes
class Player(object):
    # This is how we create an object in Python. Notice the parameters
    def __init__(self, name):
        # declare and initialize an instance variable
        # Q: We use self in Python like we use this in Java. Something very different about the two. What?
        self.name = name
        self.score = 0

    # Q: Can we use the same name "newScore" from Part 3 here? Why or why not?
    def new_score(self, newScore):
        self.score = check_high_score(self.score, newScore)

# Q: Why do we only have one parameter here, our function had two? What's going on?
